/**
 * vitest.migration-debt.mjs
 *
 * Centralised list of test files excluded due to unported infrastructure.
 * Each scoped config imports only its own domain slice so the excludes
 * travel with the domain rather than living in a single monolithic list.
 *
 * Track: https://github.com/coreblow/coreblow/issues/migration-debt
 */

/** Tests requiring gateway infrastructure not yet ported. */
export const gatewayDebtExcludes = [
...
/** Tests requiring agent/PI infrastructure not yet ported. */
export const agentsDebtExcludes = [
...
/** Tests requiring auto-reply infrastructure not yet ported. */
export const autoReplyDebtExcludes = [
...
/** Tests requiring commands infrastructure not yet ported. */
export const commandsDebtExcludes = [
...
/** Tests in other domains not yet ported. */
export const miscDebtExcludes = [
...
/**
 * All migration-debt excludes combined — use when a config covers
 * multiple domains (e.g. the base config full-run).
 */
export const allDebtExcludes = [
  ...gatewayDebtExcludes,
  ...agentsDebtExcludes,
  ...autoReplyDebtExcludes,
  ...commandsDebtExcludes,
  ...miscDebtExcludes,
];
