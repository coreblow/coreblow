...
export function applyMoonshotProviderConfig(cfg: CoreBlowConfig): CoreBlowConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: CoreBlowConfig): CoreBlowConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_CN_BASE_URL);
}

export function applyMoonshotConfig(cfg: CoreBlowConfig): CoreBlowConfig {
  return moonshotPresetAppliers.applyConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotConfigCn(cfg: CoreBlowConfig): CoreBlowConfig {
