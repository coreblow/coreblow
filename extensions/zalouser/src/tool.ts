...
import type { AnyAgentTool, CoreBlowPluginToolContext } from "../runtime-api.js";
...
type ZalouserToolContext = Pick<CoreBlowPluginToolContext, "deliveryContext">;
...
export function createZalouserTool(context?: ZalouserToolContext): AnyAgentTool {
  return {
    ...
    execute: async (toolCallId: any, params: any, signal: any, onUpdate: any) =>
