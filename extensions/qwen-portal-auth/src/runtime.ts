...
export class QwenPortalAuthRuntime {
  private extension: QwenPortalAuthExtension;
  private channels = new Map<string, QwenPortalAuthChannelImpl>();
  private running = false;

  constructor(extension: QwenPortalAuthExtension) {
  ...
  getChannel(id: string) {
    if (!this.channels.has(id)) {
      this.channels.set(id, new QwenPortalAuthChannelImpl(id));
    }
