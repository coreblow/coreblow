...
import { normalizeChannelId, type ChannelId } from "coreblow/plugin-sdk/channel-runtime";
import type {
  CoreBlowConfig,
  TtsAutoMode,
  TtsConfig,
...
import { resolvePreferredCoreBlowTmpDir } from "coreblow/plugin-sdk/sandbox";
import { CONFIG_DIR, resolveUserPath, stripMarkdown } from "coreblow/plugin-sdk/text-runtime";
import {
...
function sortSpeechProvidersForAutoSelection(cfg?: CoreBlowConfig) {
...
function resolveRegistryDefaultSpeechProviderId(cfg?: CoreBlowConfig): TtsProvider {
...
export function resolveTtsConfig(cfg: CoreBlowConfig): ResolvedTtsConfig {
...
function resolveEffectiveTtsAutoState(params: { cfg: CoreBlowConfig; sessionAuto?: string }): {
...
export function buildTtsSystemPromptHint(cfg: CoreBlowConfig): string | undefined {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: CoreBlowConfig): TtsProvider[] {
...
export async function textToSpeech(params: {
  ...
  const tempRoot = resolvePreferredCoreBlowTmpDir();
