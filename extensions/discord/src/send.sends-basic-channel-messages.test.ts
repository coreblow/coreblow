...
vi.mock("coreblow/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("coreblow/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("coreblow/plugin-sdk/web-media"));
