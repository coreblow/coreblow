...
import type { resolveAgentRoute } from "coreblow/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("coreblow/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("coreblow/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("coreblow/plugin-sdk/config-runtime").CoreBlowConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
