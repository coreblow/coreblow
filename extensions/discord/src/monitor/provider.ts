...
import type { CoreBlowConfig, ReplyToMode } from "coreblow/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "coreblow/plugin-sdk/plugin-runtime";
...
import { summarizeStringEntries } from "coreblow/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("coreblow/plugin-sdk/reply-history").HistoryEntry[]
    >();
