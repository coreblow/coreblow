...
export type DiscordConfig = NonNullable<CoreBlowConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("coreblow/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "coreblow-bot",
