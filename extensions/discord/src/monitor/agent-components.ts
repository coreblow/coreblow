...
import { resolveHumanDelayConfig } from "coreblow/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "coreblow/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "coreblow/plugin-sdk/channel-reply-pipeline";
import { enqueueSystemEvent } from "coreblow/plugin-sdk/channel-runtime";
import type { CoreBlowConfig } from "coreblow/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "coreblow/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "coreblow/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "coreblow/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "coreblow/plugin-sdk/config-runtime";
...
import { recordInboundSession } from "coreblow/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "coreblow/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "coreblow/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "coreblow/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "coreblow/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "coreblow/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "coreblow/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "coreblow/plugin-sdk/routing";
import { logVerbose } from "coreblow/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "coreblow/plugin-sdk/runtime-env";
import { logDebug, logError } from "coreblow/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__coreblow_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__coreblow_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__coreblow_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__coreblow_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__coreblow_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__coreblow_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "CoreBlow form";
  customId = "__coreblow_discord_component_modal_wildcard__";
  components = [];
