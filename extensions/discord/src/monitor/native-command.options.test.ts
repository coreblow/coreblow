...
import type { CoreBlowConfig, loadConfig } from "../../../../src/config/config.js";
...
function createNativeCommand(
  ...
  opts?: {
    ...
    discordConfig?: NonNullable<CoreBlowConfig["channels"]>["discord"];
  },
...
describe("createDiscordNativeCommand option wiring", () => {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<CoreBlowConfig["channels"]>["discord"];
