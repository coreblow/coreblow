...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "coreblow/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("coreblow.discordThreadBindingsState");
