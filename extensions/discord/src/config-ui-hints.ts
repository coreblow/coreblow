import type { ChannelConfigUiHint } from "coreblow/plugin-sdk/core";
...
export const discordChannelConfigUiHints = {
  ...
  "eventQueue.listenerTimeout": {
    ...
    help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in CoreBlow; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
  },
