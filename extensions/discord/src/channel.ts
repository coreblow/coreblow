...
} from "coreblow/plugin-sdk/allowlist-config-edit";
import {
  buildPluginApprovalRequestMessage,
  buildPluginApprovalResolvedMessage,
  type PluginApprovalRequest,
  type PluginApprovalResolved,
} from "coreblow/plugin-sdk/approval-runtime";
import { createScopedDmSecurityResolver } from "coreblow/plugin-sdk/channel-config-helpers";
import { createPairingPrefixStripper } from "coreblow/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "coreblow/plugin-sdk/channel-policy";
import { resolveTargetsWithOptionalToken } from "coreblow/plugin-sdk/channel-targets";
...
} from "coreblow/plugin-sdk/outbound-runtime";
import { normalizeMessageChannel } from "coreblow/plugin-sdk/routing";
import {
...
function hasDiscordExecApprovalDmRoute(cfg: CoreBlowConfig): boolean {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). CoreBlow adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
