...
// Runtime aliases
let _rt: NostrRuntime | undefined;
export function getNostrRuntime(): NostrRuntime { if (!_rt) _rt = new NostrRuntime(); return _rt; }
export function setNostrRuntime(r: NostrRuntime) { _rt = r; }
