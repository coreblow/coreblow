...
import { createChannelPairingController } from "coreblow/plugin-sdk/channel-pairing";
...
/**
 * Channel implementation used by nostr runtime for per-channel state.
 */
export class NostrChannelImpl {
  readonly id: string;
