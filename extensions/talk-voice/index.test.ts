...
import type { CoreBlowPluginCommandDefinition } from "../../test/helpers/extensions/plugin-command.js";
...
function createHarness(config: Record<string, unknown>) {
  ...
  const api = {
    runtime,
    registerCommand: vi.fn((definition: CoreBlowPluginCommandDefinition) => {
      command = definition;
    }),
  };
