...
function buildNoImageGenerationModelConfiguredMessage(cfg: CoreBlowConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: CoreBlowConfig }) {
