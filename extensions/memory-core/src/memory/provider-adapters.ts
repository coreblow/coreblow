...
} from "coreblow/plugin-sdk/memory-core-host-engine-embeddings";
import { resolveUserPath } from "coreblow/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "coreblow/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall CoreBlow (this should install node-llama-cpp): npm i -g coreblow@latest"
      : null,
