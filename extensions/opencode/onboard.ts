...
export function applyOpencodeZenProviderConfig(cfg: CoreBlowConfig): CoreBlowConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: CoreBlowConfig): CoreBlowConfig {
