...
export class PhoneControlRuntime {
  private extension: PhoneControlExtension;
  private channels = new Map<string, PhoneControlChannelImpl>();
  private running = false;

  constructor(extension: PhoneControlExtension) {
  ...
  getChannel(id: string) {
    if (!this.channels.has(id)) {
      this.channels.set(id, new PhoneControlChannelImpl(id));
    }
