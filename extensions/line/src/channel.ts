...
import { createRestrictSendersChannelSecurity } from "coreblow/plugin-sdk/channel-policy";
import {
...
import { resolveOutboundMediaUrls } from "coreblow/plugin-sdk/reply-payload";
import {
...
const lineSecurityAdapter = createRestrictSendersChannelSecurity<ResolvedLineAccount>({
  ...
  approveHint: "coreblow pairing approve line <code>",
