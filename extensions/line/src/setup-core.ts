import type { ChannelSetupAdapter, CoreBlowConfig } from "coreblow/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "coreblow/plugin-sdk/setup";
...
export function isLineConfigured(cfg: CoreBlowConfig, accountId: string): boolean {
