...
export const imessageDmPolicy = createTopLevelChannelDmPolicy({
  ...
  getCurrent: (cfg: CoreBlowConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
  promptAllowFrom: promptIMessageAllowFrom,
});

function resolveIMessageCliPath(params: { cfg: CoreBlowConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure CoreBlow has Full Disk Access to Messages DB.",
