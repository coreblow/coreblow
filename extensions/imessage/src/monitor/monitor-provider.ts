...
import { createChannelPairingChallengeIssuer } from "coreblow/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "coreblow/plugin-sdk/channel-reply-pipeline";
import { waitForTransportReady } from "coreblow/plugin-sdk/channel-runtime";
import { loadConfig } from "coreblow/plugin-sdk/config-runtime";
import {
...
import { normalizeScpRemoteHost } from "coreblow/plugin-sdk/host-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "coreblow/plugin-sdk/media-runtime";
import { kindFromMime } from "coreblow/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "coreblow/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "coreblow/plugin-sdk/reply-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "coreblow/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "coreblow/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T coreblow@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., coreblow@192.168.64.3)
