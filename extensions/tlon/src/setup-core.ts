...
export async function resolveTlonSetupConfigured(cfg: CoreBlowConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: CoreBlowConfig): Promise<string[]> {
