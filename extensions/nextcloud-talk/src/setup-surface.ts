import type { ChannelSetupInput } from "coreblow/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "coreblow/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "CoreBlow" "<shared-secret>" "<webhook-url>" --feature reaction',
