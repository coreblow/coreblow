/**
 * NextcloudTalk Channel Implementation
 */
import type { NextcloudTalkMessage, NextcloudTalkChannel } from '../types';

export class NextcloudTalkChannelImpl {
  private channelId: string;
  private connected = false;
  private messageQueue: NextcloudTalkMessage[] = [];
  ...
  async sendMessage(content: string, options: Record<string, any> = {}) {
    if (!this.connected) throw new Error('Not connected to nextcloud-talk');
    return {
