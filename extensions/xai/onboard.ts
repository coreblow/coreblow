...
>({
  ...
  resolveParams: (_cfg: CoreBlowConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: CoreBlowConfig): CoreBlowConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-completions");
}

export function applyXaiResponsesApiConfig(cfg: CoreBlowConfig): CoreBlowConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: CoreBlowConfig): CoreBlowConfig {
