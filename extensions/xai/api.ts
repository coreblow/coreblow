// @ts-nocheck
import { applyModelCompatPatch } from "coreblow/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "coreblow/plugin-sdk/provider-model-shared";
import { XAI_UNSUPPORTED_SCHEMA_KEYWORDS } from "coreblow/plugin-sdk/provider-tools";
