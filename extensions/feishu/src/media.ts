...
import { mediaKindFromMime } from "coreblow/plugin-sdk/media-runtime";
import { withTempDownloadPath, type CoreBlowConfig } from "../runtime-api.js";
...
function createConfiguredFeishuMediaClient(params: { cfg: CoreBlowConfig; accountId?: string }): {
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "coreblow-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "coreblow-feishu-resource-",
