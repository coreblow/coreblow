...
// Runtime aliases
let _rt: FeishuRuntime | undefined;
export function getFeishuRuntime(): FeishuRuntime { if (!_rt) _rt = new FeishuRuntime(); return _rt; }
export function setFeishuRuntime(r: FeishuRuntime) { _rt = r; }
