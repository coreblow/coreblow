...
} from "coreblow/plugin-sdk/channel-config-helpers";
import type {
...
import type { ChannelMeta, ChannelPlugin, CoreBlowConfig } from "../runtime-api.js";
import {
...
function areAnyFeishuReactionActionsEnabled(cfg: CoreBlowConfig): boolean {
      ...
      config: {
        ...
        deleteAccount: ({ cfg, accountId }) => {
          ...
          if (isDefault) {
            ...
            const next = { ...cfg } as CoreBlowConfig;
...
/**
 * Channel implementation used by feishu runtime for per-channel state.
 */
export class FeishuChannelImpl {
  readonly id: string;
