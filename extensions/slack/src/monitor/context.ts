...
import { resolveSessionKey, type SessionScope } from "coreblow/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "coreblow/plugin-sdk/config-runtime";
import { createDedupeCache } from "coreblow/plugin-sdk/core";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("coreblow/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
