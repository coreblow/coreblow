...
function enableSlackAccount(cfg: CoreBlowConfig, accountId: string): CoreBlowConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: CoreBlowConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: CoreBlowConfig; accountId: string }) =>
