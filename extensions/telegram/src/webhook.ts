...
import { isDiagnosticsEnabled } from "coreblow/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "coreblow/plugin-sdk/runtime-env";
import { defaultRuntime } from "coreblow/plugin-sdk/runtime-env";
...
} from "coreblow/plugin-sdk/text-runtime";
import {
  applyBasicWebhookRequestGuards,
  createFixedWindowRateLimiter,
  WEBHOOK_RATE_LIMIT_DEFAULTS,
} from "coreblow/plugin-sdk/webhook-ingress";
import { readJsonBodyWithLimit } from "coreblow/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: CoreBlowConfig): string {
