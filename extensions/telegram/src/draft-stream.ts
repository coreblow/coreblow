...
import { createFinalizableDraftLifecycle } from "coreblow/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("coreblow.telegramDraftStreamState");
