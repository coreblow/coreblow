...
type FetchRemoteMediaFn = typeof import("coreblow/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as CoreBlowConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("coreblow/plugin-sdk/media-runtime")>,
) {
...
vi.mock("coreblow/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("coreblow/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("coreblow/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
