...
import type { TelegramAccountConfig } from "coreblow/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("coreblow/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("coreblow/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("coreblow/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("coreblow/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("coreblow/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("coreblow/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("coreblow/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as CoreBlowConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as CoreBlowConfig),
