...
type DescribeImageWithModel =
  typeof import("coreblow/plugin-sdk/media-runtime").describeImageWithModel;
type TranscribeFirstAudio = typeof import("coreblow/plugin-sdk/media-runtime").transcribeFirstAudio;
