...
import { resolveAgentMaxConcurrent } from "coreblow/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "coreblow/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: CoreBlowConfig): RunOptions<unknown> {
  return {
    sink: {
