...
} from "coreblow/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "coreblow/plugin-sdk/config-runtime";
import { extractToolSend } from "coreblow/plugin-sdk/tool-send";
import {
