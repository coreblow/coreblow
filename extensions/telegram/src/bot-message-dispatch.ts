...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "coreblow/plugin-sdk/agent-runtime";
...
import { clearHistoryEntriesIfEnabled } from "coreblow/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "coreblow/plugin-sdk/reply-runtime";
import { danger, logVerbose } from "coreblow/plugin-sdk/runtime-env";
...
async function resolveStickerVisionSupport(cfg: CoreBlowConfig, agentId: string) {
  try {
