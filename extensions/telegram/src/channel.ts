...
import { buildPluginApprovalRequestMessage } from "coreblow/plugin-sdk/approval-runtime";
...
import { createChannelDirectoryAdapter } from "coreblow/plugin-sdk/directory-runtime";
import {
...
function hasTelegramExecApprovalDmRoute(cfg: CoreBlowConfig): boolean {
