...
function createCfg(): CoreBlowConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: CoreBlowConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: CoreBlowConfig, accountId: string) {
...
function startTelegramAccount(cfg: CoreBlowConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: CoreBlowConfig) {
