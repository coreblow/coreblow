...
function shouldShowTelegramDmAccessWarning(cfg: CoreBlowConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`coreblow config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`coreblow config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
