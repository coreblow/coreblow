...
import type { CoreBlowConfig } from "../../test-support.js";
import { ensureBrowserControlAuth } from "./control-auth.js";

describe("ensureBrowserControlAuth", () => {
  async function expectNoAutoGeneratedAuth(cfg: CoreBlowConfig): Promise<void> {
    const result = await ensureBrowserControlAuth({
      cfg,
      env: { COREBLOW_BROWSER_AUTO_AUTH: "1" },
    });
