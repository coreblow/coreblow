...
import { createAttachedChannelResultAdapter } from "coreblow/plugin-sdk/channel-send-result";
...
/**
 * Channel implementation used by BluebubblesRuntime for per-channel state.
 */
export class BluebubblesChannelImpl {
  readonly id: string;
