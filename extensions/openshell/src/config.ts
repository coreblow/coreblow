...
import { buildPluginConfigSchema, type CoreBlowPluginConfigSchema } from "coreblow/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): CoreBlowPluginConfigSchema {
