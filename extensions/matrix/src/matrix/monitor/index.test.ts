...
import { loadRuntimeApiExportTypesViaJiti } from "../../../../../test/helpers/extensions/jiti-runtime-api.ts.js";
  ...
  it("loads the matrix src runtime api through Jiti without duplicate export errors", () => {
    ...
    expect(
      loadRuntimeApiExportTypesViaJiti({
        ...
        exportNames: [],
        realPluginSdkSpecifiers: [
          "coreblow/plugin-sdk/account-helpers",
          "coreblow/plugin-sdk/allow-from",
          "coreblow/plugin-sdk/channel-config-helpers",
          "coreblow/plugin-sdk/channel-policy",
          "coreblow/plugin-sdk/core",
          "coreblow/plugin-sdk/directory-runtime",
          "coreblow/plugin-sdk/extension-shared",
          "coreblow/plugin-sdk/irc",
          "coreblow/plugin-sdk/signal",
          "coreblow/plugin-sdk/status-helpers",
          "coreblow/plugin-sdk/text-runtime",
        ],
      }),
    ).toEqual({});
  }, 240_000);
