...
import { isSecretRef, type CoreBlowConfig } from "coreblow/plugin-sdk/core";
import { safeParseJsonWithSchema, safeParseWithSchema } from "coreblow/plugin-sdk/extension-shared";
import { z } from "zod";
...
export function listEnabledGoogleChatAccounts(cfg: CoreBlowConfig): ResolvedGoogleChatAccount[] {
