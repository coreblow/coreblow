/**
 * Synology Chat Channel Plugin for CoreBlow.
 *
 * Implements the ChannelPlugin interface following the LINE pattern.
 */

import type { CoreBlowConfig } from "coreblow/plugin-sdk/account-resolution";
import {
  createHybridChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "coreblow/plugin-sdk/channel-config-helpers";
import { waitUntilAbort } from "coreblow/plugin-sdk/channel-lifecycle";
import {
...
import { attachChannelToResult } from "coreblow/plugin-sdk/channel-send-result";
import { createChatChannelPlugin, type ChannelPlugin } from "coreblow/plugin-sdk/core";
import { createEmptyChannelDirectoryAdapter } from "coreblow/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "coreblow pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: CoreBlowConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: CoreBlowConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to CoreBlow",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "CoreBlow: your access has been approved.",
