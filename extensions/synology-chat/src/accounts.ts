...
import { resolveDangerousNameMatchingEnabled } from "coreblow/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full CoreBlow config object. */
function getChannelConfig(cfg: CoreBlowConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: CoreBlowConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.COREBLOW_BOT_NAME ?? "CoreBlow";
