...
vi.mock("coreblow/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("coreblow/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("coreblow/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("coreblow/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("coreblow/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("coreblow/plugin-sdk/webhook-ingress");
  return {
    ...actual,
