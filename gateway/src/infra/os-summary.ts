 ...
 * CoreBlow — OS Summary
 *
 * Resolves a human-readable summary of the current operating system,
 * used in diagnostics, doctor command, and telemetry.
 *
...
/**
 * Resolves a summary object describing the current OS environment.
 */
