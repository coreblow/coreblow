...
export const onboardingFlow: FlowDefinition = {
    ...
    steps: [
        { id: 'welcome', prompt: '👋 Welcome to CoreBlow! What should I call you?', next: 'model' },
        {
            ...
            validator: (input) => ({ valid: ['1', '2', '3'].includes(input.trim()), error: 'Please choose 1, 2, or 3.' }),
            transform: (input) => ({ '1': 'gpt-4o', '2': 'claude-sonnet-4-20250514', '3': 'gemini-2.5-pro' }[input.trim()]),
            next: 'done',
        },
