 ...
 * Runtime requirement evaluation and config path resolution.
 * Ported from CoreBlow shared/config-eval.ts with CoreBlow OOP adaptations.
 */
...
export type RuntimeRequirementEvalParams = {
...
/** Clear the binary cache — for testing only. */
