...
import { detectMime, getMimeType } from "../media/mime.js";
import { resolveFileWithinRoot } from "./file-resolver.js";

export const A2UI_PATH = "/__coreblow__/a2ui";

export const CANVAS_HOST_PATH = "/__coreblow__/canvas";

export const CANVAS_WS_PATH = "/__coreblow__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.coreblowCanvasA2UIAction.postMessage(...)
  // - Android: window.coreblowCanvasA2UIAction.postMessage(...)
  const handlerNames = ["coreblowCanvasA2UIAction"];
  ...
  globalThis.CoreBlow = globalThis.CoreBlow ?? {};
  globalThis.CoreBlow.postMessage = postToNode;
  globalThis.CoreBlow.sendUserAction = sendUserAction;
  globalThis.coreblowPostMessage = postToNode;
  globalThis.coreblowSendUserAction = sendUserAction;
