...
function resolveResolutionLimits(config: CoreBlowConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CoreBlowConfig): SecretProviderConfig {
