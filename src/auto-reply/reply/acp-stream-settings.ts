...
function resolveAcpStreamCoalesceIdleMs(cfg: CoreBlowConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CoreBlowConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CoreBlowConfig): AcpProjectionSettings {
