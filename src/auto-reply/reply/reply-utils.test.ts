...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bcoreblow\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "CoreBlow",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[CoreBlow] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
