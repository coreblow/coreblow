...
function createDiscordParams(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
...
function createThreadParams(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
...
async function runDiscordAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(createDiscordParams(commandBody, cfg), true);
}

async function runThreadAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(createThreadParams(commandBody, cfg), true);
}

async function runTelegramAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
...
async function runTelegramDmAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runSlackDmAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
function createMatrixThreadParams(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
...
async function runMatrixAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runMatrixThreadAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(createMatrixThreadParams(commandBody, cfg), true);
}

async function runFeishuDmAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runBlueBubblesDmAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runIMessageDmAcpCommand(commandBody: string, cfg: CoreBlowConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
