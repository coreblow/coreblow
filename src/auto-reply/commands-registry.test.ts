...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@coreblow", { botUsername: "coreblow" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@coreblow args", {
        botUsername: "coreblow",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@coreblow: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "coreblow" })).toBe(
      "/help@otherbot",
    );
  });
