...
export function isCommandEnabled(cfg: CoreBlowConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: CoreBlowConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: CoreBlowConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: CoreBlowConfig) {
