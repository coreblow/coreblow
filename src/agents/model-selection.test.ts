...
function resolveAnthropicOpusThinking(cfg: CoreBlowConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<CoreBlowConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<CoreBlowConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<CoreBlowConfig> = {
        agents: {
          defaults: {
            models: {
