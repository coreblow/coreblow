...
function resolveAvatarSource(cfg: CoreBlowConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CoreBlowConfig, agentId: string): AgentAvatarResolution {
