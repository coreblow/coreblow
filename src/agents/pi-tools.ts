...
function applyModelProviderToolPolicy(
  ...
  // Models with a native web_search tool cannot receive CoreBlow's
...
function resolveExecConfig(params: { cfg?: CoreBlowConfig; agentId?: string }) {
...
export function createCoreBlowCodingTools(options?: {
  agentId?: string;
