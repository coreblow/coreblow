...
export type SearchConfigRecord = (NonNullable<CoreBlowConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("coreblow.web-search.cache");
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.coreblow.com/tools/web";
