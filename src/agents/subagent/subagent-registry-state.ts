/**
 * CoreBlow — Subagent Registry State (CoreBlow Parity)
 *
 * Persist/restore subagent run records to/from disk.
 */
...
export function persistSubagentRunsToDisk(runs: Map<string, SubagentRunRecord>): void {
    try {
...
export function getSubagentRunsSnapshotForRead(
    ...
    const shouldReadDisk =
        process.env.COREBLOW_TEST_READ_SUBAGENT_RUNS_FROM_DISK === '1' ||
