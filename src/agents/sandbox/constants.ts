...
export const DEFAULT_SANDBOX_IMAGE = "coreblow-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "coreblow-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "coreblow-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "coreblow-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "coreblow-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "coreblow-sandbox-browser";
