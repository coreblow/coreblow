...
async function resolveContext(config: CoreBlowConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CoreBlowConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
