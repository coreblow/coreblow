...
export const createCoreBlowCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createCoreBlowCodingToolsMock.mockReset();
  createCoreBlowCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureCoreBlowModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveCoreBlowDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createCoreBlowCodingTools: createCoreBlowCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveCoreBlowAgentDir: vi.fn(() => "/tmp"),
  }));
