...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CoreBlowConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CoreBlowConfig; env: NodeJS.ProcessEnv }): {
  cfg: CoreBlowConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
