...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "coreblow/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "coreblow/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "coreblow/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, CoreBlowConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "coreblow/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "coreblow/plugin-sdk/matrix-runtime-shared";',
  ...
  "extensions/nextcloud-talk/runtime-api.ts": [
    'export * from "coreblow/plugin-sdk/nextcloud-talk";',
  ],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, CoreBlowConfig, CoreBlowPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "coreblow/plugin-sdk/telegram-core";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { CoreBlowPluginService, CoreBlowPluginServiceContext, PluginLogger } from "coreblow/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "coreblow/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "coreblow/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "coreblow/plugin-sdk/telegram-core";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "coreblow/plugin-sdk/telegram-core";',
