...
import type {
  ...
  CoreBlowPluginApi as CoreCoreBlowPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "coreblow/plugin-sdk/core";
import * as providerEntrySdk from "coreblow/plugin-sdk/provider-entry";
...
import type { CoreBlowPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  CoreBlowPluginApi as SharedCoreBlowPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreCoreBlowPluginApi>().toMatchTypeOf<CoreBlowPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreCoreBlowPluginApi>().toMatchTypeOf<SharedCoreBlowPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/global-singleton"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/huggingface"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("coreblow/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`coreblow/plugin-sdk/${id}`),
      ),
    ]);
