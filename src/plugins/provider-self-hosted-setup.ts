...
export function applyProviderDefaultModel(cfg: CoreBlowConfig, modelRef: string): CoreBlowConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: CoreBlowConfig; modelId: string; modelRef: string; profileId: string } {
