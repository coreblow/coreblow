...
vi.mock("./loader.js", () => ({
  loadCoreBlowPlugins: (...args: unknown[]) => mocks.loadCoreBlowPlugins(...args),
}));
...
function expectPluginLoaderConfig(config: CoreBlowConfig) {
  expect(mocks.loadCoreBlowPlugins).toHaveBeenCalledWith(
...
function expectAutoEnabledCliLoad(params: {
  rawConfig: CoreBlowConfig;
  autoEnabledConfig: CoreBlowConfig;
}) {
...
function expectCliRegistrarCalledWithConfig(config: CoreBlowConfig) {
...
describe("registerPluginCliCommands", () => {
  beforeEach(() => {
    ...
    mocks.loadCoreBlowPlugins.mockReset();
    mocks.loadCoreBlowPlugins.mockReturnValue(createCliRegistry());
