...
import type { PluginConfigUiHint, CoreBlowPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: CoreBlowPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): CoreBlowPluginConfigSchema {
  return {
