...
import { loadCoreBlowPlugins, type PluginLoadOptions } from "./loader.js";
import type { CoreBlowPluginCliCommandDescriptor } from "./types.js";
...
export function getPluginCliCommandDescriptors(
  ...
  try {
    ...
    const descriptors: CoreBlowPluginCliCommandDescriptor[] = [];
