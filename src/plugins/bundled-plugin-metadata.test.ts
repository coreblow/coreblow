...
describe("bundled plugin metadata", () => {
  ...
  it("prefers built generated paths when present and falls back to source paths", () => {
    const tempRoot = createGeneratedPluginTempRoot("coreblow-bundled-plugin-metadata-");
  ...
  it("supports check mode for stale generated artifacts", async () => {
    const tempRoot = createGeneratedPluginTempRoot("coreblow-bundled-plugin-generated-");
    ...
    writeJson(path.join(tempRoot, "extensions", "alpha", "coreblow.plugin.json"), {
      id: "alpha",
  ...
  it("merges generated channel schema metadata with manifest-owned channel config fields", async () => {
    const tempRoot = createGeneratedPluginTempRoot("coreblow-bundled-plugin-channel-configs-");
  ...
  it("captures top-level public surface artifacts without duplicating the primary entrypoints", async () => {
    const tempRoot = createGeneratedPluginTempRoot("coreblow-bundled-plugin-public-artifacts-");
