...
const { getInstance: getOutboundSendService, __testing: __testing_outboundSend } =
  createStandaloneSingleton({ create: () => new OutboundSendService(), defaultDeps: {} });

export { getOutboundSendService, __testing_outboundSend };
