...
describe("npm registry spec validation", () => {
  it.each([
    "@coreblow/voice-call",
    "@coreblow/voice-call@1.2.3",
    "@coreblow/voice-call@1.2.3-beta.4",
    "@coreblow/voice-call@latest",
    "@coreblow/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/coreblow/coreblow",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@coreblow/voice-call@1.2.3-beta.1",
      expected: {
        name: "@coreblow/voice-call",
        raw: "@coreblow/voice-call@1.2.3-beta.1",
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@coreblow/voice-call@latest",
  ...
  it.each([
    {
      spec: "@coreblow/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@coreblow/voice-call@beta"`,
    },
    {
      spec: "@coreblow/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
