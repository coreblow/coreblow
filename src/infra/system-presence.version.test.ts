  ...
  return withEnvAsync(
    {
      ...
      COREBLOW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when COREBLOW_VERSION is not set", async () => {
  ...
  it("prefers COREBLOW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over COREBLOW_SERVICE_VERSION when COREBLOW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        COREBLOW_VERSION: " ",
        COREBLOW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when COREBLOW_VERSION and COREBLOW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        COREBLOW_VERSION: " ",
        COREBLOW_SERVICE_VERSION: "\t",
