...
const { getInstance: getRetryPolicyService, __testing: __testing_retryPolicy } =
  createStandaloneSingleton({ create: () => new RetryPolicyService(), defaultDeps: {} });

export { getRetryPolicyService, __testing_retryPolicy };
