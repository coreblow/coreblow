...
const CORE_PACKAGE_NAMES = new Set(["coreblow", "@coreblow/coreblow"]);
...
export async function resolveCoreBlowPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveCoreBlowPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
