...
function collectExecSafeBinScopes(cfg: CoreBlowConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: CoreBlowConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: CoreBlowConfig): {
