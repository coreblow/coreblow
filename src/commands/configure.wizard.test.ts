...
vi.mock("../config/config.js", () => ({
  CONFIG_PATH: "~/.coreblow/coreblow.json",
...
vi.mock("./onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "~/.coreblow/workspace",
  applyWizardMetadata: (cfg: CoreBlowConfig) => cfg,
...
describe("runConfigureWizard", () => {
  beforeEach(() => {
    ...
    mocks.setupSearch.mockImplementation(async (cfg: CoreBlowConfig) => cfg);
  });
  ...
  it("persists provider-owned web search config changes returned by setupSearch", async () => {
    setupBaseWizardState();
    mocks.setupSearch.mockImplementation(async (cfg: CoreBlowConfig) =>
