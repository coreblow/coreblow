...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: CoreBlowConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: CoreBlowConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: CoreBlowConfig) => string;
  setAccountEnabled?: (params: {
    cfg: CoreBlowConfig;
    accountId: string;
    enabled: boolean;
  }) => CoreBlowConfig;
  deleteAccount?: (params: { cfg: CoreBlowConfig; accountId: string }) => CoreBlowConfig;
  isEnabled?: (account: ResolvedAccount, cfg: CoreBlowConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: CoreBlowConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: CoreBlowConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: CoreBlowConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: CoreBlowConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.coreblow.com/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: CoreBlowConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: CoreBlowConfig;
    nextCfg: CoreBlowConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: CoreBlowConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: CoreBlowConfig; accountId?: string | null }) =>
    | {
