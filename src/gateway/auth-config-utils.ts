import type { GatewayAuthConfig, CoreBlowConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: CoreBlowConfig, password: string): CoreBlowConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
