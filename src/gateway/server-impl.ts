...
export class GatewayServer {
    ...
    private _resolvedAuth!: ResolvedGatewayAuth;
    private _bootReady: boolean = false;
    /**
     * ReadinessChecker — pola CoreBlow createReadinessChecker().
     ...
     */
    private _getReadiness: ReadinessChecker;
    ...
    async start(): Promise<void> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.server!.listen(this.config.port, this.config.host, () => {
                ...
                // Pola OC: checker dibuat sekali, dipegang, dipanggil per-request.
    ...
    private createRequestHandler(): (req: IncomingMessage, res: ServerResponse) => void {
        return (req, res) => {
            ...
            // Pola OC: probe routes di-handle sebelum semua middleware lain
            ...
            if ((method === 'GET' || method === 'HEAD') && isHealthProbePath(pathname)) {
                handleHealthProbeRequest(req, res, pathname, {
                    ...
                    // Identik pola OC: getReadiness dipanggil langsung per-request
