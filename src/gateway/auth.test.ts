...
describe("gateway auth", () => {
  ...
  it("resolves token/password from COREBLOW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          COREBLOW_GATEWAY_TOKEN: "env-token",
          COREBLOW_GATEWAY_PASSWORD: "env-password",
    ...
    expect(
      resolveGatewayAuth({
        authConfig: {
          ...
          password: "${COREBLOW_GATEWAY_PASSWORD}",
        },
        env: {
          COREBLOW_GATEWAY_TOKEN: "env-token",
          COREBLOW_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides COREBLOW_GATEWAY_PASSWORD", () => {
