...
function listConfiguredAgentIds(cfg: CoreBlowConfig): string[] {
...
export function listAgentsForGateway(cfg: CoreBlowConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CoreBlowConfig): string {
...
function resolveSessionStoreAgentId(cfg: CoreBlowConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CoreBlowConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: CoreBlowConfig): GatewaySessionsDefaults {
