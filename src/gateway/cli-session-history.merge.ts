...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__coreblow" in message &&
    (message as { __coreblow?: unknown }).__coreblow &&
    typeof (message as { __coreblow?: unknown }).__coreblow === "object"
      ? ((message as { __coreblow?: Record<string, unknown> }).__coreblow ?? {})
      : undefined;
