...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CoreBlowConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CoreBlowConfig): void {
