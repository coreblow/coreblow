...
describe("credential-precedence parity", () => {
  ...
  const gatewayEnv = {
    COREBLOW_GATEWAY_TOKEN: "env-token", // pragma: allowlist secret
  ...
  const cases: TestCase[] = [
    {
      name: "local mode: env overrides config for call/probe, status and auth remain config-first",
      cfg: {
        gateway: {
          mode: "local",
          auth: {
