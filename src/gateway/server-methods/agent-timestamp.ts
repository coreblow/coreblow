 ...
 *
 * @see https://github.com/coreblow/coreblow/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an CoreBlowConfig.
 */
export function timestampOptsFromConfig(cfg: CoreBlowConfig): TimestampInjectionOptions {
  return {
