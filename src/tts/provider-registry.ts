...
function resolveSpeechProviderPluginEntries(cfg?: CoreBlowConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: CoreBlowConfig): {
...
export function listSpeechProviders(cfg?: CoreBlowConfig): SpeechProviderPlugin[] {
