...
function resolveAnthropicDefaultAuthMode(cfg: CoreBlowConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyTalkApiKey(config: CoreBlowConfig): CoreBlowConfig {
...
export function applyTalkConfigNormalization(config: CoreBlowConfig): CoreBlowConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyLoggingDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyContextPruningDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyCompactionDefaults(cfg: CoreBlowConfig): CoreBlowConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
