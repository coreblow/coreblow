...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.remote.apiKey": "Remote Embedding API Key", // pragma: allowlist secret
  ...
  "plugins.corehub": "CoreHub Plugin Policy",
  "plugins.corehub.allowCommunity": "Allow CoreHub Community Packages",
  "plugins.corehub.allowDeprecated": "Allow Deprecated CoreHub Versions",
  "plugins.corehub.allowedPublishers": "Allowed CoreHub Publishers",
  "plugins.corehub.requiredVerificationTiers": "Required CoreHub Verification Tiers",
  ...
  "plugins.installs.*.artifactSha256": "Plugin Artifact SHA-256",
  "plugins.installs.*.artifactSize": "Plugin Artifact Size",
  "plugins.installs.*.artifactManifestVerified": "Plugin Artifact Manifest Verified",
