const DEFAULT_TAGLINE = "All your chats, one CoreBlow.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little automation assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew workflows—type something and let the bot pinch the busywork.",
  ...
  "Automation with focus: minimal fuss, maximal pinch.",
  ...
  "Core in, commit ready—let's ship something mildly responsible.",
  ...
  "Built by builders, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'coreblow gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.COREBLOW_TAGLINE_INDEX;
