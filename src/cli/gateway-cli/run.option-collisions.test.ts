...
vi.mock("../../config/config.js", () => ({
  getConfigPath: () => "/tmp/coreblow-test-missing-config.json",
...
describe("gateway run option collisions", () => {
  ...
  it.each([
    ...
    delete process.env.COREBLOW_CLI_BACKEND_LOG_OUTPUT;
    ...
    expect(process.env.COREBLOW_CLI_BACKEND_LOG_OUTPUT).toBe("1");
  });
