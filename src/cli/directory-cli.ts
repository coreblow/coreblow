    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["coreblow directory self --channel slack", "Show the connected account identity."],
          [
            'coreblow directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["coreblow directory groups list --channel discord", "List available groups/channels."],
          [
            "coreblow directory groups members --channel discord --group-id <id>",
