...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage CoreBlow MCP config and channel bridge");
