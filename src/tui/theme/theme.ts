...
function isLightBackground(): boolean {
  const explicit = process.env.COREBLOW_THEME?.toLowerCase();
  if (explicit === "light") {
    return true;
  }
  if (explicit === "dark") {
...
export const markdownTheme: MarkdownTheme = {
  heading: (text: any) => chalk.bold(fg(palette.accent)(text)),
  link: (text: any) => fg(palette.link)(text),
  linkUrl: (text: any) => chalk.dim(text),
  code: (text: any) => fg(palette.code)(text),
  codeBlock: (text: any) => fg(palette.code)(text),
  codeBlockBorder: (text: any) => fg(palette.codeBorder)(text),
  quote: (text: any) => fg(palette.quote)(text),
  quoteBorder: (text: any) => fg(palette.quoteBorder)(text),
  hr: (text: any) => fg(palette.border)(text),
  listBullet: (text: any) => fg(palette.accentSoft)(text),
  bold: (text: any) => chalk.bold(text),
  italic: (text: any) => chalk.italic(text),
  strikethrough: (text: any) => chalk.strikethrough(text),
  underline: (text: any) => chalk.underline(text),
  highlightCode,
};

const baseSelectListTheme: SelectListTheme = {
  selectedPrefix: (text: any) => fg(palette.accent)(text),
  selectedText: (text: any) => chalk.bold(fg(palette.accent)(text)),
  description: (text: any) => fg(palette.dim)(text),
  scrollInfo: (text: any) => fg(palette.dim)(text),
  noMatch: (text: any) => fg(palette.dim)(text),
};
...
export const settingsListTheme: SettingsListTheme = {
  label: (text: any, selected: any) =>
    selected ? chalk.bold(fg(palette.accent)(text)) : fg(palette.text)(text),
  value: (text: any, selected: any) => (selected ? fg(palette.accentSoft)(text) : fg(palette.dim)(text)),
  description: (text: any) => fg(palette.systemText)(text),
  cursor: fg(palette.accent)("→ "),
  hint: (text: any) => fg(palette.dim)(text),
};

export const editorTheme: EditorTheme = {
  borderColor: (text: any) => fg(palette.border)(text),
