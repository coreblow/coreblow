...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("coreblow.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("coreblow.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: CoreBlowConfig): Promise<ContextEngine> {
