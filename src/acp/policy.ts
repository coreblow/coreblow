...
export function isAcpEnabledByPolicy(cfg: CoreBlowConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: CoreBlowConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: CoreBlowConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: CoreBlowConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: CoreBlowConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: CoreBlowConfig, agentId: string): boolean {
