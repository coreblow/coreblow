...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: CoreBlowConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: CoreBlowConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: CoreBlowConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: CoreBlowConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: CoreBlowConfig }): Promise<void> {
