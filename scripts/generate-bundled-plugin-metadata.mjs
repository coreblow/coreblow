...
function resolvePackageChannelMeta(packageJson) {
  const coreblowMeta =
    ...
    "coreblow" in packageJson
      ? packageJson.coreblow
      : undefined;
  if (!coreblowMeta || typeof coreblowMeta !== "object" || Array.isArray(coreblowMeta)) {
    return undefined;
  }
  const channelMeta = coreblowMeta.channel;
