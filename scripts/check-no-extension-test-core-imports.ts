...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']coreblow\/plugin-sdk["']/,
    hint: "Use coreblow/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']coreblow\/plugin-sdk\/test-utils["']/,
    hint: "Use coreblow/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']coreblow\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or coreblow/plugin-sdk/testing for public surfaces.",
  },
  {
