...
export const OPTIONAL_BUNDLED_BUILD_ENV = "COREBLOW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.coreblow?.install?.npmSpec === "string" &&
    packageJson.coreblow.install.npmSpec.trim().length > 0
  );
}
