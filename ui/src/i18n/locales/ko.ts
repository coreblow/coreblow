...
export const ko: TranslationMap = {
  ...
  overview: { access: { title: "게이트웨이 접근", subtitle: "대시보드 연결 위치 및 인증 방법.", wsUrl: "WebSocket URL", token: "게이트웨이 토큰", password: "비밀번호", connectHint: "연결을 클릭하여 연결 변경 사항을 적용하세요." }, health: { title: "시스템 상태", checkHealth: "시스템 상태 확인", started: "시스템 시작됨", pollFailed: "상태 확인 실패" }, status: { connected: "연결됨", connectedServer: "게이트웨이 서버에 연결됨", disconnected: "연결 해제됨", notConnected: "연결되지 않음", reconnect: "게이트웨이 재연결", reconnectWs: "WebSocket 재연결", coreblowOnline: "CoreBlow 온라인" } },
