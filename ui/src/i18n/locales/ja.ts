...
export const ja: TranslationMap = {
  ...
  overview: { access: { title: "ゲートウェイアクセス", subtitle: "ダッシュボードの接続先と認証方法。", wsUrl: "WebSocket URL", token: "ゲートウェイトークン", password: "パスワード", connectHint: "接続をクリックして接続変更を適用します。" }, health: { title: "システムヘルス", checkHealth: "システムヘルスを確認", started: "システム開始", pollFailed: "ヘルスチェック失敗" }, status: { connected: "接続済み", connectedServer: "ゲートウェイサーバーに接続済み", disconnected: "切断済み", notConnected: "未接続", reconnect: "ゲートウェイに再接続", reconnectWs: "WebSocketに再接続", coreblowOnline: "CoreBlow オンライン" } },
