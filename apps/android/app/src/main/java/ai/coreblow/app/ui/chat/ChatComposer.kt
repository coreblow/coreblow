...
import ai.coreblow.app.ui.mobileAccentBorderStrong
...
import ai.coreblow.app.ui.mobileSurface
import ai.coreblow.app.ui.mobileText
import ai.coreblow.app.ui.mobileTextSecondary
import ai.coreblow.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.coreblow.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.coreblow.app.ui.mobileFontFamily,
