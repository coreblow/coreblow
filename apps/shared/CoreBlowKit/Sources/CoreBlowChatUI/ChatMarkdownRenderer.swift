...
/// Chat markdown rendering variant controlling layout density.
public enum ChatMarkdownVariant: String, CaseIterable, Sendable {
    case standard
    case compact
}

/// CoreBlow: Markdown rendering view for chat messages.
///
/// Supports standard and compact layout variants, inline images,
/// and syntax highlighting via Textual's StructuredText API.
@MainActor
