...
public struct CoreBlowChatUsageCost: Codable, Hashable, Sendable {
...
public struct CoreBlowChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: CoreBlowChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(CoreBlowChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct CoreBlowChatMessageContent: Codable, Hashable, Sendable {
...
public struct CoreBlowChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [CoreBlowChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: CoreBlowChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [CoreBlowChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: CoreBlowChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(CoreBlowChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([CoreBlowChatMessageContent].self, forKey: .content) {
...
public struct CoreBlowChatHistoryPayload: Codable, Sendable {
...
public struct CoreBlowSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct CoreBlowSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [CoreBlowSessionPreviewItem]
}

public struct CoreBlowSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [CoreBlowSessionPreviewEntry]

    public init(ts: Int, previews: [CoreBlowSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct CoreBlowChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct CoreBlowChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct CoreBlowAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct CoreBlowChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct CoreBlowGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct CoreBlowPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: CoreBlowPlatformImage?
...
public struct CoreBlowChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
