...
/// CoreBlow: Original implementation of Canvas Command parameters.
/// 1. Pattern borrowed: Models defining canvas configuration payload data.
/// 2. Implemented differently: Named `CoreBlowCanvasParams` to cleanly group properties, utilizing explicit Codable bindings.

public struct CoreBlowCanvasParams: Codable, Sendable, Equatable {
    public let enabled: Bool
    public let renderingMode: String
    public let updateFrequency: Int?

    public init(enabled: Bool, renderingMode: String, updateFrequency: Int? = nil) {
