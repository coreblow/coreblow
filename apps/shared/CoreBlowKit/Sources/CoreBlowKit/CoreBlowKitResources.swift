...
/// CoreBlow: Safe resource bundle resolution for the CoreBlowKit Swift package.
///
...
public enum CoreBlowResources {
    public static let activeBundle: Bundle = locateBundle()

    private static let bundleName = "CoreBlowKit_CoreBlowKit"
...
/// Convenience alias matching the package name pattern.
public enum CoreBlowKitResources {
    public static var bundle: Bundle { CoreBlowResources.activeBundle }
}
