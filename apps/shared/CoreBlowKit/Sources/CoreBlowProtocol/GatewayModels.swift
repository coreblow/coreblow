// CoreBlow gateway protocol models — generated from protocol specification.
...
// WizardStep is defined in FlexValueHelpers.swift using FlexValue types.
// The protocol-gen AnyCodable version is intentionally omitted to avoid
// duplicate symbol conflicts within the CoreBlowProtocol module.
...
public struct TalkConfigParams: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case includesecrets = "includeSecrets" // pragma: allowlist secret
    }
}
...
// CronJob is defined in the main CoreBlow target (CronModels.swift)
...
// CronRunLogEntry is defined in the main CoreBlow target (CronModels.swift)
...
// GatewayFrame is defined in GatewayFrames.swift using typed FrameKind
// discriminator with .request/.response/.event cases.
// The protocol-gen version is intentionally omitted to avoid duplicate
// symbol conflicts within the CoreBlowProtocol module.
