...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.coreblow.gateway"
    private static let nodeService = "ai.coreblow.node"
    private static let talkService = "ai.coreblow.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.coreblow.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.coreblow.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("coreblow-gateway.log")
    }
