...
enum UIStrings {
    static let welcomeTitle = "Welcome to CoreBlow"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "coreblow.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: CoreBlowChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g coreblow@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: CoreBlowChatViewModel(
