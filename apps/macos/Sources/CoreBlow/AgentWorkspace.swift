...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.coreblow", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CoreBlowConfigFile.defaultWorkspaceURL() }
