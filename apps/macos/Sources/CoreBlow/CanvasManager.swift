...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.coreblow", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("CoreBlow/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__coreblow__/a2ui/").absoluteString + "?platform=macos"
    }
