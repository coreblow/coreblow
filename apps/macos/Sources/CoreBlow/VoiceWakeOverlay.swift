...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.coreblow", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other CoreBlow windows, but below the system’s pop-up menus.
