...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.coreblow", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install CoreBlow CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .coreblowSelectSettingsTab, object: tab)
        }
    }
