...
private let onboardingWizardLogger = Logger(subsystem: "ai.coreblow", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between CoreBlowProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = CoreBlowProtocol.AnyCodable
