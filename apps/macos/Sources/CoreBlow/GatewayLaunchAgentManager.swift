...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.coreblow", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".coreblow/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.coreblowCommand(
            subcommand: "gateway",
