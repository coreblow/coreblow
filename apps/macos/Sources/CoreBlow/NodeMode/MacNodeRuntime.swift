...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case CoreBlowBrowserCommand.proxy.rawValue:
            ...
            case CoreBlowLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case CoreBlowSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case CoreBlowSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case CoreBlowSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case CoreBlowSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case CoreBlowSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case CoreBlowCanvasA2UICommand.push.rawValue,
             CoreBlowCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard CoreBlowConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: CoreBlowNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__coreblow__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(CoreBlowSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: CoreBlowSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> CoreBlowLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: CoreBlowNodeError(code: code, message: message))
    }
