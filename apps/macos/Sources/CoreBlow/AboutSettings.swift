...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/coreblow/coreblow") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/coreblow/coreblow")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://coreblow.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "CoreBlowBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CoreBlowBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CoreBlowGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CoreBlowGitCommit") as? String) ??
            "unknown"
    }
