import { resolveNormalizedAccountEntry } from "coreblow/plugin-sdk/account-resolution";
 ...
 *
 * See: https://github.com/coreblow/coreblow/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: CoreBlowConfig, accountId: string): boolean {
