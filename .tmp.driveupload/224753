...
import type { CoreBlowPluginApi } from "../types.js";
...
export function createPluginRegistryFixture(config = {} as CoreBlowConfig) {
  return {
    config,
...
export function registerVirtualTestPlugin(params: {
  ...
  register(this: void, api: CoreBlowPluginApi): void;
}) {
  registerTestPlugin({
