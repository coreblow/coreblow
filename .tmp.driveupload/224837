...
export function applyGoogleGeminiModelDefault(cfg: CoreBlowConfig): {
  next: CoreBlowConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyOpenAIConfig(cfg: CoreBlowConfig): CoreBlowConfig {
...
export function applyOpencodeGoModelDefault(cfg: CoreBlowConfig): {
  next: CoreBlowConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: CoreBlowConfig): {
  next: CoreBlowConfig;
  changed: boolean;
} {
