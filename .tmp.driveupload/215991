...
export function listAuthProfileStorePaths(config: CoreBlowConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: CoreBlowConfig, stateDir: string): string[] {
