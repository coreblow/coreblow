import { resolveAccountWithDefaultFallback } from "coreblow/plugin-sdk/account-resolution";
import type { CoreBlowConfig } from "coreblow/plugin-sdk/config-runtime";
import { coerceSecretRef } from "coreblow/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "coreblow/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "coreblow/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "coreblow/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: CoreBlowConfig; value: unknown }): {
  token: string;
