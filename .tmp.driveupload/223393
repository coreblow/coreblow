...
if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "coreblow/extension-api is deprecated. Migrate to api.runtime.agent.* or focused coreblow/plugin-sdk/<subpath> imports. See https://docs.coreblow.ai/plugins/sdk-migration",
    {
      code: "OPENCLAW_EXTENSION_API_DEPRECATED",
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.coreblow.ai/plugins/sdk-migration",
    },
  );
}
