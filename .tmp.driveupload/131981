...
import { GatewayClient } from "coreblow/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "coreblow/plugin-sdk/gateway-runtime";
import type { EventFrame } from "coreblow/plugin-sdk/gateway-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "coreblow/plugin-sdk/routing";
...
import { compileSafeRegex, testRegexWithBoundedInput } from "coreblow/plugin-sdk/security-runtime";
...
function isHandlerConfigured(params: { cfg: CoreBlowConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
