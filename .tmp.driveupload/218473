...
export function resolveSubagentToolPolicy(cfg?: CoreBlowConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: CoreBlowConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: CoreBlowConfig["tools"];
