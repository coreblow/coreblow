...
function makeCfg(overrides?: Partial<CoreBlowConfig>): CoreBlowConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): CoreBlowConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: CoreBlowConfig) {
