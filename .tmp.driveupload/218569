...
function resolveWatchPaths(workspaceDir: string, config?: CoreBlowConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CoreBlowConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CoreBlowConfig }) {
