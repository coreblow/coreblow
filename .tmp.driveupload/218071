...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "coreblow-sbx-test",
    runtimeLabel: params.containerName ?? "coreblow-sbx-test",
    containerName: params.containerName ?? "coreblow-sbx-test",
