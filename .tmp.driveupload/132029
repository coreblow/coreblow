...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "coreblow/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://coreblow.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("coreblow logs --follow")}\` (safest)`,
