...
export function resolveTavilySearchConfig(cfg?: CoreBlowConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: CoreBlowConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: CoreBlowConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
