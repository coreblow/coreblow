...
import {
  ...
  resolveUserPath,
  type CoreBlowConfig,
} from "coreblow/plugin-sdk/account-core";
...
export function listWhatsAppAuthDirs(cfg: CoreBlowConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CoreBlowConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CoreBlowConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CoreBlowConfig): ResolvedWhatsAppAccount[] {
