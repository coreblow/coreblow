...
import { buildPluginConfigSchema } from "coreblow/plugin-sdk/core";
import { z } from "coreblow/plugin-sdk/zod";
import type { CoreBlowPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "coreblow.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): CoreBlowPluginConfigSchema {
