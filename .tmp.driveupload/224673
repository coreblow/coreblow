...
import { normalizeCoreBlowVersionBase } from "../config/version.js";
...
import { loadCoreBlowPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeCoreBlowVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeCoreBlowVersionBase(plugin.version) ??
    plugin.version
  );
}
