...
// Default to CoreBlow workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".coreblow", "workspace", "media", "inbound");
 ...
 * Format matches CoreBlow's expected attachment structure.
 */
