/**
 * hooks/hooks.ts — Public API barrel for the hooks subsystem.
 *
 * Mirrors CoreBlow's hooks/hooks.ts — provides clean re-exports
 * so consumers can `import { registerHook, triggerHook } from "./hooks/hooks.js"`
