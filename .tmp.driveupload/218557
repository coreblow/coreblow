...
const { streamSimpleMock, buildSessionContextMock, getLeafEntryMock, branchMock, resetLeafMock, ensureCoreBlowModelsJsonMock, discoverAuthStorageMock, discoverModelsMock, resolveModelWithRegistryMock, getApiKeyForModelMock, requireApiKeyMock, resolveSessionAuthProfileOverrideMock, getActiveEmbeddedRunSnapshotMock, diagDebugMock } = vi.hoisted(() => ({
  streamSimpleMock: vi.fn(),
  buildSessionContextMock: vi.fn(),
  getLeafEntryMock: vi.fn(),
  branchMock: vi.fn(),
  resetLeafMock: vi.fn(),
  ensureCoreBlowModelsJsonMock: vi.fn(),
  discoverAuthStorageMock: vi.fn(),
  discoverModelsMock: vi.fn(),
  resolveModelWithRegistryMock: vi.fn(),
  getApiKeyForModelMock: vi.fn(),
  requireApiKeyMock: vi.fn(),
  resolveSessionAuthProfileOverrideMock: vi.fn(),
  getActiveEmbeddedRunSnapshotMock: vi.fn(),
  diagDebugMock: vi.fn(),
}));
...
vi.mock("@mariozechner/pi-coding-agent", () => ({
  ...
  AuthStorage: class AuthStorage { getApiKey() { return ""; } setApiKey() {} listProviders() { return []; } },
}));

vi.mock("./models-config.js", () => ({
  ensureCoreBlowModelsJson: (...args: unknown[]) => ensureCoreBlowModelsJsonMock(...args),
}));
...
describe("runBtwSideQuestion", () => {
  beforeEach(() => {
    ...
    ensureCoreBlowModelsJsonMock.mockReset();
