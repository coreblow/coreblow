...
type LoginOpenAICodexOAuth =
  (typeof import("coreblow/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("coreblow/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("coreblow/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("coreblow/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("coreblow/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("coreblow/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("coreblow/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("coreblow/plugin-sdk/provider-auth")>();
  return {
    ...actual,
