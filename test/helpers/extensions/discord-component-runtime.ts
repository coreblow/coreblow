...
vi.mock("coreblow/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("coreblow/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("coreblow/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
...
export function resetDiscordComponentRuntimeMocks() {
  ...
  resolvePluginConversationBindingApprovalMock.mockReset().mockResolvedValue({
    ...
    binding: {
      ...
      pluginName: "CoreBlow App Server",
