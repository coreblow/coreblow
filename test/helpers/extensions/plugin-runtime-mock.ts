import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "coreblow/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "coreblow/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "coreblow/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/coreblow"),
    },
    modelAuth: {
